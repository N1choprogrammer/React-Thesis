-- -- Repair duplicate-account views when older view columns already exist.
-- -- Run this file if 202608110003 failed with:
-- -- "cannot change name of view column full_name_fingerprint to profile_id"
